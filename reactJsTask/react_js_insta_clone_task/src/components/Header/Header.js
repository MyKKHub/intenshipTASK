          ...
          <div className={`${isMobileMenuOpen ? 'block' : 'hidden'}`}>
            <ul className="navbar-nav mt-3 flex-column">
              <div>
                ...
                <NavLink className="nav-link" to="/">
                  <img src={search} alt="search" className="icon"/> <b className='nav-text'>Search</b>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/">
                  <img src={explore} alt="explore" className="icon"/> <b className='nav-text'>Explore</b>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/reels">
                  <img src={reels} alt="reels" className="icon"/> <b className='nav-text'>Reels</b>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/">
                  <img src={message} alt="message" className="icon"/> <b className='nav-text'>Messages</b>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/">
                  <img src={notify} alt="notify" className="icon"/> <b className='nav-text'>Notifications</b>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/">
                  <img src={create} alt="create" className="icon"/> <b className='nav-text'>Create</b>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/">
